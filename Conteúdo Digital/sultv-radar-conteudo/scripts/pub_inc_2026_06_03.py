#!/usr/bin/env python3
"""
pub_inc_2026_06_03.py — publicador INCREMENTAL e resumível (cowork-faz-tudo).
...
com estado persistente, de forma idempotente:
  ...
  - Posts FB/IG: NÃO têm dedup nativo. Este driver rastreia em
    state/social_posted_2026-06-03.json (id_hash -> resultado) e pula o que já saiu.

Uso:
  python3 pub_inc_2026_06_03.py materias --max 1     # publica 1 matéria pendente
  python3 pub_inc_2026_06_03.py posts    --max 2     # publica 2 posts pendentes
  python3 pub_inc_2026_06_03.py status               # mostra o que falta
"""
